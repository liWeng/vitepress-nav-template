import{_ as s,o as n,c as a,a as e}from"./app.e6daa892.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":3,"title":"编写人员","slug":"编写人员","link":"#编写人员","children":[]},{"level":3,"title":"如果安装错误，则执行下列清空环境命令","slug":"如果安装错误-则执行下列清空环境命令","link":"#如果安装错误-则执行下列清空环境命令","children":[]}],"relativePath":"articles/deploy/数据库-mongodb副本集-仲裁安装.md","lastUpdated":1697780285000}'),l={name:"articles/deploy/数据库-mongodb副本集-仲裁安装.md"},p=e(`<h3 id="编写人员" tabindex="-1">编写人员 <a class="header-anchor" href="#编写人员" aria-hidden="true">#</a></h3><h4 id="环境说明" tabindex="-1">环境说明 <a class="header-anchor" href="#环境说明" aria-hidden="true">#</a></h4><pre><code>第一个节点：10.10.10.62 主节点
第二个节点：10.10.10.63 从节点
第二个节点：10.10.10.64 从节点
</code></pre><h4 id="所有节点执行" tabindex="-1">所有节点执行 <a class="header-anchor" href="#所有节点执行" aria-hidden="true">#</a></h4><h5 id="相关依赖" tabindex="-1">相关依赖 <a class="header-anchor" href="#相关依赖" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">yum install numactl wget lsof telnet -y</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h5 id="生成认证文件-在一台服务器上生成-用来节点之间通信-主节点操作10-10-10-62" tabindex="-1">生成认证文件(在一台服务器上生成)用来节点之间通信 (主节点操作10.10.10.62) <a class="header-anchor" href="#生成认证文件-在一台服务器上生成-用来节点之间通信-主节点操作10-10-10-62" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">openssl rand -base64 100 &gt;  /data/mongodb/mongokey/mongodb-keyfile</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>复制到其他服务器</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">scp /data/mongodb/mongokey/mongodb-keyfile root@10.10.10.63:/data/mongodb/mongokey/</span></span>
<span class="line"><span style="color:#A6ACCD;">scp /data/mongodb/mongokey/mongodb-keyfile root@10.10.10.64:/data/mongodb/mongokey/</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>设置权限</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">chmod  600  /data/mongodb/mongokey/mongodb-keyfile</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h5 id="主节点10-10-10-62配置文件" tabindex="-1">主节点10.10.10.62配置文件 <a class="header-anchor" href="#主节点10-10-10-62配置文件" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat &gt;&gt; /data/mongodb/conf/node.conf  &lt;&lt;  EOF</span></span>
...
<span class="line"><span style="color:#A6ACCD;">       cacheSizeGB: 10</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  maxIncomingConnections: 1000</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    oplogSizeMB: 20480</span></span>
<span class="line"><span style="color:#A6ACCD;">    replSetName: shard1</span></span>
<span class="line"><span style="color:#A6ACCD;">operationProfiling:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  authorization: enabled</span></span>
<span class="line"><span style="color:#A6ACCD;">  clusterAuthMode: keyFile</span></span>
<span class="line"><span style="color:#A6ACCD;">  keyFile: /data/mongodb/mongokey/mongodb-keyfile </span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br></div></div><h5 id="从节点10-10-10-63配置文件" tabindex="-1">从节点10.10.10.63配置文件 <a class="header-anchor" href="#从节点10-10-10-63配置文件" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat &gt;&gt; /data/mongodb/conf/node.conf  &lt;&lt;  EOF</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"># where to write logging data.</span></span>
<span class="line"><span style="color:#A6ACCD;">systemLog:</span></span>
<span class="line"><span style="color:#A6ACCD;">  destination: file</span></span>
...
<span class="line"><span style="color:#A6ACCD;">net:</span></span>
<span class="line"><span style="color:#A6ACCD;">  port: 27017</span></span>
<span class="line"><span style="color:#A6ACCD;">  bindIp: 10.10.10.63,127.0.0.1</span></span>
<span class="line"><span style="color:#A6ACCD;">  maxIncomingConnections: 1000</span></span>
<span class="line"><span style="color:#A6ACCD;">#operationProfiling:</span></span>
<span class="line"><span style="color:#A6ACCD;">replication:</span></span>
<span class="line"><span style="color:#A6ACCD;">    oplogSizeMB: 20480</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  replWriterThreadCount: 4</span></span>
<span class="line"><span style="color:#A6ACCD;">EOF</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br></div></div><h5 id="从节点10-10-10-64配置文件" tabindex="-1">从节点10.10.10.64配置文件 <a class="header-anchor" href="#从节点10-10-10-64配置文件" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat &gt;&gt; /data/mongodb/conf/node.conf  &lt;&lt;  EOF</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"># where to write logging data.</span></span>
<span class="line"><span style="color:#A6ACCD;">systemLog:</span></span>
<span class="line"><span style="color:#A6ACCD;">  destination: file</span></span>
...
<span class="line"><span style="color:#A6ACCD;">net:</span></span>
<span class="line"><span style="color:#A6ACCD;">  port: 27017</span></span>
<span class="line"><span style="color:#A6ACCD;">  bindIp: 10.10.10.64,127.0.0.1</span></span>
<span class="line"><span style="color:#A6ACCD;">  maxIncomingConnections: 1000</span></span>
<span class="line"><span style="color:#A6ACCD;">#operationProfiling:</span></span>
<span class="line"><span style="color:#A6ACCD;">replication:</span></span>
<span class="line"><span style="color:#A6ACCD;">    oplogSizeMB: 20480</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  replWriterThreadCount: 4</span></span>
<span class="line"><span style="color:#A6ACCD;">EOF</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br></div></div><h5 id="启动所有节点-所有节点依次执行" tabindex="-1">启动所有节点，所有节点依次执行 <a class="header-anchor" href="#启动所有节点-所有节点依次执行" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">numactl --interleave=all mongod  --config /data/mongodb/conf/node.conf</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h5 id="登录第一个节点执行初始化-10-10-10-62" tabindex="-1">登录第一个节点执行初始化（10.10.10.62） <a class="header-anchor" href="#登录第一个节点执行初始化-10-10-10-62" aria-hidden="true">#</a></h5><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">mongo 127.0.0.1:27017</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">config = {</span></span>
<span class="line"><span style="color:#A6ACCD;">    _id : &quot;shard1&quot;,</span></span>
<span class="line"><span style="color:#A6ACCD;">     members : [</span></span>
<span class="line"><span style="color:#A6ACCD;">         {_id : 0, host : &quot;10.10.10.62:27017&quot;,priority:3 },</span></span>
<span class="line"><span style="color:#A6ACCD;">         {_id : 1, host : &quot;10.10.10.63:27017&quot;,priority:2 },</span></span>
<span class="line"><span style="color:#A6ACCD;">         {_id : 2, host : &quot;10.10.10.64:27017&quot;,priority:1 }</span></span>
<span class="line"><span style="color:#A6ACCD;">     ]</span></span>
<span class="line"><span style="color:#A6ACCD;"> }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>执行初始化命令</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">rs.initiate(config);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>查看集群状态</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">rs.status();</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>为shard集群的设置root密码</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">db.createUser(</span></span>
<span class="line"><span style="color:#A6ACCD;"> {</span></span>
<span class="line"><span style="color:#A6ACCD;"> user:&quot;root&quot;,</span></span>
<span class="line"><span style="color:#A6ACCD;"> pwd: &quot;Hhwyadmin2021&quot;,</span></span>
<span class="line"><span style="color:#A6ACCD;"> roles: [{ role: &quot;root&quot;, db: &quot;admin&quot;}]</span></span>
<span class="line"><span style="color:#A6ACCD;"> }</span></span>
<span class="line"><span style="color:#A6ACCD;"> );</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"> db.auth(&quot;root&quot;,&quot;Hhwyadmin2021&quot;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,60),r=[p];function i(o,c,t,b,d,C){return n(),a("div",null,r)}const A=s(l,[["render",i]]);export{u as __pageData,A as default};
