import{_ as s,o as n,c as a,a as l}from"./app.e6daa892.js";const C=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/deploy/数据库-PXC5.7集群安装.md","lastUpdated":1697780285000}'),e={name:"articles/deploy/数据库-PXC5.7集群安装.md"},p=l(`<h4 id="编写人员" tabindex="-1">编写人员 <a class="header-anchor" href="#编写人员" aria-hidden="true">#</a></h4><h4 id="原版文档" tabindex="-1">原版文档 <a class="header-anchor" href="#原版文档" aria-hidden="true">#</a></h4><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">https://www.percona.com/doc/percona-xtradb-cluster/LATEST/install/tarball.html#tarball</span></span>
